...
const birthday_moduleRoutes = require('./routes/birthday_module');
...
app.use('/api/:slug/birthday_module', resolveTenant, requireModule('birthday_module'), birthday_moduleRoutes);
